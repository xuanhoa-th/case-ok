...
require "model/login/LoginDB.php";
require "model/login/register.php";
require "model/login/registerDB.php";
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span> <?php echo $_SESSION['isAuth']['name']?> <i class="caret"></i></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo 'index.php?page=logout' ?>" class="btn btn-default btn-flat">Đăng xuất</a>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p> <?php echo $_SESSION['isAuth']['name']?></p>
